...
void main() {
  group('Carousel controller tests', () {
    test('Create', () {
      expect(() => TvCarouselController(itemCount: 0), throwsArgumentError);
      expect(() => TvCarouselController(itemCount: -1), throwsArgumentError);
    ...
    test('Reset', () {
      ...
      expect(() => controller.reset(count: 0), throwsArgumentError);
      expect(() => controller.reset(count: -1), throwsArgumentError);
      ...
      expect(() => controller.reset(count: 5), throwsArgumentError);
    ...
    test('Select', () {
      ...
      expect(() => controller.select(5), returnsNormally);
      expect(controller.selectedIndex, 5);

      expect(() => controller.select(10), throwsArgumentError);
    ...
    test('Scroll', () {
      ...
      expect(controller.scrollLeft, throwsArgumentError);
      expect(controller.itemCount, 3);
      expect(controller.selectedIndex, 0);
      ...
      expect(controller.scrollRight, throwsArgumentError);
      expect(controller.itemCount, 3);
      expect(controller.selectedIndex, 2);
